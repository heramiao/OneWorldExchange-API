...
User.create(first_name: "Hera", last_name: "Miao", email: "heram@andrew.cmu.edu", phone: "630-890-3971", password: "password", base_currency: "USD", password_confirmation: "password", balance: 57.39)
